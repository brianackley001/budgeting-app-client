...
// Methods: 
        ...
        const result = await axiosInstance.post(`/transaction/${item.transactionId}`,
          {
            ...
            personalFinanceCategory: { 
              primary: formParentCategory, 
              detailed: formSubCategory 
            },
            tags: trackedTags,
          });
  ...
  const handleParentCategorySelectChange = (value) => {
    ...
    setFormParentCategory(value);;
  }
  const handleSubcategorySelectChange = (value) => {
    ...
    <>
      <tr onClick={handleShowDetail}>
        ...
        <td className="transactionGridLineItem">
          {item.userNotes && item.userNotes.length > 0 && (
            <span className="iconStyle" title={item.userNotes}>
              <FontAwesomeIcon
                icon={faNoteSticky}
                size="sm"
                style={{ color: "#ecc63c" }}
      ...
      >
        ...
        >
          ...
          <Modal.Body>
            <Card>
              <CardTitle as="h6" className="navbarStyle">
                {" "}
                {isEditMode
                  ? "Edit Transaction"
                ...
                >
                  {!isEditMode && (
                    ...
                    >
                      <FontAwesomeIcon icon={faPencil} className="iconStyle" />
                      Edit
                    </Button>
                  )}
                </span>
              ...
              <CardBody>
                ...
                {isEditMode && (
                  <span
                    className="card-text"
                    id="transactionDetailEditFormTransaction"
                    data-testid="transaction-detail=read-only-container"
                  >
                    <Row className="mb-3 transactionModalSummary">
                      <Col xs={12}>
                        Appears on your <b>{item.bankAccountName}</b> statement
                        as "
                        <b>
                    ...
                    <Row className="mb-3">
                      <Col xs={2}>
                        <Form.Group
                          className="mb-3"
                          controlId="formGridTransactionDate"
                        >
                      ...
                      <Col xs={8}>
                        <Form.Group
                          as={Col}
                          controlId="formGridTransactionDescription"
                        >
                          ...
                          <Form.Control
                            ...
                            style={{ fontSize: ".90em" }}
                          />
                          <Form.Control.Feedback data-testid="transaction-detail-form-transaction-name-is-valid">
                            Looks good!
                          </Form.Control.Feedback>
                          <Form.Control.Feedback
                            type="invalid"
                            data-testid="transaction-detail-form-transaction-name-is-invalid"
                          >
                    ...
                    <TransactionCategorizationSelect
          ...
          <Modal.Footer>
            ...
            {isEditMode && (
              <Button
                variant="primary"
                type="submit"
                data-testid="transaction-detail-form-submit-btn"
              >
                Save Changes
              </Button>
            )}
